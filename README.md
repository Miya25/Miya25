...
<img src="https://skillicons.dev/icons?i=java,css,html,docker,discord,net,r,rust,tailwind,github,git,lua,cloudflare,astro,pug,go,nodejs,nextjs,mongodb,react,redis,tailwind,ts,vscode,typescript,twitter,visualstudio,express,vue,linux,markdown,materialui,mysql,netlify,nginx,nuxtjs,c,cpp&theme=dark" />
</div>
